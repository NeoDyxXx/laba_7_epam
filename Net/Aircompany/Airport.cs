...
namespace Aircompany
{
    public class Airport
    {
        ...
        public PassengerPlane GetPassengerPlaneWithMaxPassengersCapacity()
        {
            ...
            return passengerPlanes.Aggregate((passengerPlaneOne, passengerPlaneTwo) 
                => passengerPlaneOne.GetPassengersCapacity() > passengerPlaneTwo.GetPassengersCapacity() 
                ? passengerPlaneOne : passengerPlaneTwo);             
        }
        ...
        {
            return "Airport{" +
                    "planes=" + string.Join(", ", planes.Select(x => x.GetNameModelType())) +
                    '}';
        }
    }
}
